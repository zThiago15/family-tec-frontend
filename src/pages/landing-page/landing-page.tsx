      ...
      <main className="pt-16">
        <section id="home" className="pt-8 lg:flex bg-primary-color items-center ">
          <div className="w-full">
            ...
            <ul className="flex flex-col items-center flex-wrap my-10">
            ...
            <div className="text-center">
              ...
              <a
                ...
                className="flex justify-evenly text-center w-60 p-4 mt-5 mx-auto bg-green-500 text-white rounded-full mb-5 hover:bg-green-600 px-5 lg:w-[30%]"
                target='_blank'
              >
        ...
        <section id="about-us" className="bg-background-color p-5 w-full">
          ...
          <a
            href="https://wa.me/5511986198559?text=Olá,%20gostaria%20de%20agendar%20uma%20visita" 
            className="flex justify-evenly text-center p-4 mt-5 mx-auto bg-red-500 text-white rounded-full mb-5 hover:bg-red-600 px-5 lg:w-[30%]"
            target='_blank'
          >
